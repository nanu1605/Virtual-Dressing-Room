...
buttono = tk.Label(text="VIRTUAL \n DRESSING ROOM",height=2,width=45,fg="black",bg="#bef062",font=("times",15,"bold"))
buttono.place(x=50,y=50)
dirPath = "testpicture"
...
def inimage():
    ...
    img2 = tk.Label(image=render1, height="300", width="300")
    img2.image = render1
...
#continuously captures frames from a webcam, performs pose estimation using the OpenPose model, and overlays the detected
    ...
    ######################END OF WRAP######################
buttono = tk.Button(text="CLICK TO CHECK OUTPUT", command = CLICK,height=1,width=35,fg="black",bg="#bef062",font=("times",15,"bold"))
buttono.place(x=1000,y=200)
buttono = tk.Button(text="UPLOAD A DRESS", command = openphoto,height=1,width=15,fg="black",bg="#bef062",font=("times",15,"bold"))
buttono.place(x=100,y=600)
buttonr = tk.Button(text="START CAMERA", command = start,height=1,width=15,fg="black",bg="#bef062",font=("times",15,"bold"))
buttonr.place(x=1000,y=500)
buttonr = tk.Button(text="UPLOAD IMAGE", command = inimage,height=1,width=15,fg="black",bg="#bef062",font=("times",15,"bold"))
buttonr.place(x=100,y=300)
window.mainloop()
